...
export const Designforgroup = () => {
    ...
    const handleSubmit = (e) => {
        ...
        try {
            ...
            console.log(e)
            toast.error("Enter all field values")
        }
    }
    ...
    return (
        <div>
            <div className="w-full my-2 font-bold  flex  items-center">
                <button className="md:w-[15%] w-1/2 shadow-lg shadow-gray-500 mx-[3%] md:mx-[20%]  bg-[#00A79D] text-white p-2 text-xl">
                    See all members

                </button>
            </div>
            <div className="text-2xl md:text-3xl font-sans font-bold md:text-center mb-5 mx-12 text-[#21E5D9] dark:bg-blue-500 dark:bg-gradient-to-br dark:from-blue-500 dark:to-[#21E535]   dark:bg-clip-text dark:text-transparent">Design For Others</div>
            ...
            <div className="flex flex-col p-4 mb-[3%]  text-black bg-white border-white shadow-xl shadow-gray-400 dark:shadow-gray-800 rounded-3xl border-2 mx-[7%] md:mx-[20%]">
                ...
                <div className=" md:px-[10%] ">
                    <div className="flex flex-col md:items-center md:flex-row  md:space-x-4 ">
                        <div className="text-[#5C5C5C] text-[18px] font-[600] my-2 text-left ">Subject: </div>
                        <div className="flex my-2 p-2 w-full justify-start items-center rounded-md shadow-md shadow-gray-300  border-2 border-gray-400 ">
                            ...
                            <div className="w-full"> <input type="text" value={subject} onChange={(e) => setSubject(e.target.value)} className=" w-full focus:outline-none  p-1 text-[#2B2B2B] " placeholder="Enter subject" />  </div>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-between  my-5 md:space-x-4 ">
                        <div className="md:flex w-[45%] md:space-x-5 ">
                            ...
                            <div className="flex space-x-1 md:space-x-5 w-full justify-between items-center   ">
                                <div className=" w-[50%] border-b-2 border-black ">
                                    <DatePicker
                                        selectsStart
                                        selected={startDate}
                ...
                <button onClick={handleSubmit} className='w-1/2 mx-auto my-[5%] md:my-[3%]  bg-[#21E535]  dark:bg-blue-500 dark:bg-gradient-to-br dark:from-blue-500 dark:to-[#21E535] py-[1%] text-white rounded-lg font-bold  leading-7 text-xl md:text-2xl' >Done</button>
